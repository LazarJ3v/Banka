namespace Prodavnica
{
    partial class PocetnaStranica
    {
        ...
        private void InitializeComponent()
        {
            ...
            pictureBox1.Location = new Point(170, 23);
            pictureBox1.Margin = new Padding(5, 6, 5, 6);
            pictureBox1.Name = "pictureBox1";
            pictureBox1.Size = new Size(378, 376);
            ...
            label1.Font = new Font("Modern No. 20", 24F, FontStyle.Bold, GraphicsUnit.Point, 0);
            label1.Location = new Point(79, 408);
            label1.Margin = new Padding(5, 0, 5, 0);
            label1.Name = "label1";
            label1.Size = new Size(515, 100);
            label1.TabIndex = 1;
            label1.Text = "BANKA";
            // 
            // PocetnaStranica
            ...
            ClientSize = new Size(722, 1006);
            Controls.Add(label1);
            Controls.Add(pictureBox1);
            Margin = new Padding(5, 6, 5, 6);
            MaximizeBox = false;
            MaximumSize = new Size(744, 1062);
            MinimizeBox = false;
            MinimumSize = new Size(744, 1006);
